...
class Preprocessor(object):
  ...
  @staticmethod
  def get_filename(self,str,ext=".ttf"):
    """
  ...
  @staticmethod
  def extract_imgs_from_zip(zip_):
    """
    Generator that extracts multiple images as numpy arrays (one per character) from a zip file
  ...
  def crop_img(im):
    """
    Crops numpy array according to smalles bounding box for non-zero elements
    """
    bf = io.BytesIO()
